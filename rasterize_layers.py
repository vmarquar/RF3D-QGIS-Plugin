...
def rasterizeMultiFieldVectorLayer(vector_filepath, output_ascii_dir, dem_transform_data, exlude_list=['id', 'ID'], GDT_DataType={'d1':gdal.GDT_Float32, 'd2':gdal.GDT_Float32, 'd3':gdal.GDT_Float32}, keeptif=True, NoData_value=-9999):
    """
